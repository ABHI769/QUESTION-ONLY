...
async function sendQuestion() {
    ...
    if (!question) {
        showValidationError('Please enter some text');
        return;
    }
    
    // Allow any input to go through - server will validate and declare AI winner if invalid
    // This enables the AI to win when user types something without a question mark
